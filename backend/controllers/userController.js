...
// API to cancal Appointment
const cancalAppointment = async (req, res) => {
  try {
...
export { regsiterUser, loginUser, getProfile,updateProfile,bookAppointment,listAppointment,cancalAppointment,paymentRazorpay,verifyRazorpay};
